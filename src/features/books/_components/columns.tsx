...
function getCategoryName(categories: Array<Category>, categoryId: string) {
  return (
...
export const columns =
  ...
  (actions?: DataTableActions<Book>): Array<ColumnDef<Book>> => {
    const bookColumns: Array<ColumnDef<Book>> = [
      {
        id: "title",
        accessorKey: "title",
        header: "Title",
      ...
      {
        id: "category",
        accessorFn: (row) => getCategoryName(categories, row.categoryId),
        header: "Category",
      },
      {
        id: "availability",

...
export function AdminShell({ title, subtitle, children }: AdminShellProps) {
  ...
  return (
    <div className="flex min-h-svh bg-muted/[0.35]">
      <aside
        className={cn(
          "hidden shrink-0 flex-col bg-primary text-primary-foreground transition-[width] duration-300 lg:flex",
      ...
      >
        ...
        <div className={cn("flex-1 py-5", sidebarCollapsed ? "px-2" : "px-4")}>
          {navigation}
        </div>
